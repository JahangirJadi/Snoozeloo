...
@Composable
fun ItemAlarmRingtone(modifier: Modifier = Modifier,
    ...
    AppCard {
        Row(
            ...
            AppText16(text = stringResource(R.string.alarm_ringtone),
                fontWeight = FontWeight.W600,
                )

            AppText14(text = currentRingtone,
...
@Preview
@Composable
private fun ItemAlarmRingtonePickerPreview() {
    SnoozelooTheme {
        ItemAlarmRingtone(currentRingtone="Default", onClick = {})
    }
}